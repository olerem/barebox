...
#include <mach/qca_soc_common.h>
#include <mach/qca95xx_pll_init.h>
...
ahb_clk_calculation:
	/* t5 = REDIV * (2 ^ OUTDIV) * (AHB_POST_DIV + 1) */
	mul t5, t5, t3
	nop
	nop
	...
	/* t6 = CLOCK_DIVIDER for SPI FLASH clock */
	li t6, 0
